...
var output = [
  // Modernizr + jQuery + jQuery Migrate
  {
    ...
    files: [
      'modernizr-2.6.2.js',
      'jquery-1.10.2/jquery-1.10.2.js'
    ]
  },
  ...
  // Bootstrap
  {
    ...
    files: [
      'bootstrap-2.3.2/bootstrap-transition.js',
      'bootstrap-2.3.2/bootstrap-alert.js',
      'bootstrap-2.3.2/bootstrap-button.js',
      'bootstrap-2.3.2/bootstrap-carousel.js',
      'bootstrap-2.3.2/bootstrap-collapse.js',
      'bootstrap-2.3.2/bootstrap-dropdown.js',
      'bootstrap-2.3.2/bootstrap-modal.js',
      'bootstrap-2.3.2/bootstrap-tooltip.js',
      'bootstrap-2.3.2/bootstrap-popover.js',
      'bootstrap-2.3.2/bootstrap-scrollspy.js',
      'bootstrap-2.3.2/bootstrap-tab.js',
      'bootstrap-2.3.2/bootstrap-typeahead.js',
      'bootstrap-2.3.2/bootstrap-affix.js'
    ]
  },
  ...
  // AdminFlare
  {
    ...
    files: [
      // Single Plugins
      'iscroll-lite-4.2.0.js',
      'bootstrap-colorpicker.js',
      'bootstrap-datepicker.js',
      'bootstrap-timepicker.js',
      'bootstrap-notify-1.0.0.js',
      'jquery.toggles-2.0.4.js',
      'bootbox-3.3.0.js',
      'bootstrap-x-clickover-1.0.0.js',
      'jquery.autosize-1.17.1.js',
      'jqBootstrapValidation-1.3.7.js',
      'jquery.maskedinput-1.3.1.js',
      'jquery.easy-pie-chart-1.2.1.js',
      'jquery.sparkline-2.1.2.js',
      'bootstrap-markdown-1.1.2.js',
      'prettify.min.js',
      'markdown.js',
      ...
      // Bootstrap-editable
      'bootstrap-editable-1.4.5/bootstrap-editable.js',
      'bootstrap-editable-1.4.5/bootstrap-editable-address.js',
    
      // jQuery Flot
      'flot-0.8.1/jquery.flot.js',
      'flot-0.8.1/jquery.flot.pie.js',
